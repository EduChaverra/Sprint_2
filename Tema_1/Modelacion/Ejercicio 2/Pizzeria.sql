...
CREATE TABLE `Cliente` (
  `id` int NOT NULL,
  `nombre` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `apellidos` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `direccion` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `codigo_postal` char(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `localidad` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `provincia` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `Producto` (
  ...
  `nombre` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `descripcion` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `imagen` blob,
...
CREATE TABLE `Domicilio` (
  ...
  `fecha/hora` timestamp(6) NULL DEFAULT NULL,
  ...
  CONSTRAINT `id_repartidor` FOREIGN KEY (`id_repartidor`) REFERENCES `Empleado` (`id`)
);
